...
RAPID.load = function(filename, callback) {
	// USAGE:
	//
	//	RAPID.load("file.txt", function(data) {
	//		// file.txt loaded and returned data, we can access it here
	//	}
	//
	var xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			console.log("got file contents: " + this.responseText.substring(0, 8) + " (...)");
