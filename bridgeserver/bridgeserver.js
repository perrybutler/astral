...
var clientPath = "../astral/";
var assetPath = "../astral/assets";
...
function makePrefab(spl) {
	...
	//jsonString = "\"" + jsonString + "\"";
	//var jsonObject = JSON.parse(JSON.parse(jsonString));
	//fs.writeFileSync("../astral/assets/test.prefab", JSON.stringify(jsonObject, null, 4));
	jsonString = JSON.stringify(JSON.parse(jsonString), null, 4);
	fs.writeFileSync("../astral/assets/" + name + ".prefab", jsonString);
}

console.log(getMetas("../astral/assets"));
